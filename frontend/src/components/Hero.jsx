...
export default function Hero() {
    ...
    return (
        <section className="relative w-full min-h-[90vh] md:min-h-screen flex flex-col items-center justify-center px-6 pt-24 overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] md:w-[600px] md:h-[600px] bg-blue-600/15 blur-[120px] rounded-full pointer-events-none z-0"></div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-12 lg:gap-24 w-full max-w-6xl z-10">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                        <button 
                            ...
                            className="px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-bold text-lg transition-all shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:shadow-[0_0_30px_rgba(37,99,235,0.6)] cursor-pointer"
                        >
                            Explorar Projetos ↓
                        </button>
                        <button 
                ...
                >
                    ...
                    <Lottie
                        ...
                        loop={true}
                        style={{ width: '100%', height: '100%', filter: 'drop-shadow(0px 0px 20px rgba(96,165,250,0.4))' }}
                    />
                </motion.div>
            </div>
