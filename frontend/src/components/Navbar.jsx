    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto flex items-center justify-between bg-brand-900/40 backdrop-blur-md border border-brand-700/50 rounded-2xl px-6 py-3 shadow-lg">
                ...
                <Link to="/" className="text-xl font-bold text-white tracking-wider flex items-center gap-1 hover:opacity-80 transition-opacity">
                    <img
                        src={logo}
                        alt='StLogo'
                ...
                <div className="flex items-center gap-4 md:gap-8">
                    ...
                    <button
                        ...
                        className="px-2 py-1.5 bg-brand-600 hover:bg-brand-500 text-white rounded-lg text-xs font-bold transition-all shadow-[0_0_15px_rgba(79,134,95,0.4)] hover:shadow-[0_0_25px_rgba(37,106,94,0.6)] cursor-pointer whitespace-nowrap"
                    >
                        {t('nav_articles_btn')}
                    </button>
