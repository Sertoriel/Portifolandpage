...
export default function LayoutBackground() {
    return (
        <div className="fixed inset-0 w-full h-full z-[-1] bg-[#0b0c10] overflow-hidden pointer-events-none">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#0b0c10]/30 to-[#0b0c10]/60"></div>
